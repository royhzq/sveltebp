    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "/");
    			add_location(a0, file$3, 2, 8, 41);
    			attr_dev(a1, "href", "/about");
    			add_location(a1, file$3, 3, 8, 71);
    			add_location(nav, file$3, 1, 4, 26);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 1, 0, 24);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			h2.textContent = "Home";
    			add_location(h2, file$1, 2, 4, 31);
    			add_location(div, file$1, 1, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
